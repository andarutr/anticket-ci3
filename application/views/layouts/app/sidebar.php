	...
	<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<?php if($this->session->userdata('role') == 'user'): ?>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/user/ticket/monitoring-ticket'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-ticket-perforated text-dark text-sm opacity-10"></i>
						</div>
						<span class="nav-link-text ms-1">Monitoring Ticket</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/user/ticket/close-ticket'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-ui-checks text-dark text-sm opacity-10"></i>
						</div>
						<span class="nav-link-text ms-1">Close Ticket</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/user/chat/message'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-chat text-dark text-sm opacity-10"></i>
						</div>
			...
			<?php if($this->session->userdata('role') == 'supervisor'): ?>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/supervisor/history'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-list text-dark text-sm opacity-10"></i>
						</div>
			...
			<?php if($this->session->userdata('role') == 'admin'): ?>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/admin/mappingtask'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-bounding-box text-dark text-sm opacity-10"></i>
						</div>
						<span class="nav-link-text ms-1">Mapping Task</span>
					</a>
				</li>
				<li class="nav-item">
			...
			<?php endif; ?>
			<?php if($this->session->userdata('role') == 'worker'): ?>
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/worker/dashboard'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi bi-rocket-takeoff text-dark text-sm opacity-10"></i>
						</div>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/worker/chat/message'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-chat text-dark text-sm opacity-10"></i>
						</div>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/worker/ticket'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-receipt text-dark text-sm opacity-10"></i>
						</div>
						<span class="nav-link-text ms-1">Ticket</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/worker/history'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-list text-dark text-sm opacity-10"></i>
						</div>
			...
			<?php if($this->session->userdata('role') == 'root'): ?>
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/root/dashboard'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi bi-rocket-takeoff text-dark text-sm opacity-10"></i>
						</div>
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= site_url('/root/manage-user'); ?>">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="bi-person-gear text-dark text-sm opacity-10"></i>
						</div>
