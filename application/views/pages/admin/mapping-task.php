  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="ticketIdForAssignment">
        <div class="mb-3">
          <label for="workerSelect" class="form-label">Pilih Worker:</label>
...
<script src="<?= base_url('assets/js/pages/admin/mapping-task.js'); ?>"></script>