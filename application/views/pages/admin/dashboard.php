<div class="container-fluid py-4">
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Belum Diassign</p>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Sudah Diassign</p>
                <h5 class="font-weight-bold mb-0"><?= $ticket_assigned ?? 0 ?></h5>
              </div>
            </div>
            <div class="col-4 text-end">
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Assigned Bulan Ini</p>
                <h5 class="font-weight-bold mb-0"><?= $ticket_assigned_month ?? 0 ?></h5>
              </div>
            </div>
            <div class="col-4 text-end">
  ...
  <!-- Daftar Ticket Siap Diassign -->
  <div class="row mt-4">
    <div class="col-12">
      <div class="card">
        <div class="card-header pb-0">
          <h6>Ticket Siap Diassign</h6>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <?php else: ?>
                  <tr>
                    <td colspan="8" class="text-center text-muted">Tidak ada ticket yang menunggu assignment</td>
                  </tr>
                <?php endif; ?>
              </tbody>
            </table>
...
<script src="<?= base_url('assets/js/pages/admin/dashboard.js'); ?>"></script>